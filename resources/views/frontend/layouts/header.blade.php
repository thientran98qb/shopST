            ...
            <div class="container">
                <div class="pull-left auto-width-left">
                    <ul class="top-menu menu-beta l-inline">
                        <li><a href=""><i class="fa fa-home"></i> Thành Phố Đà Nẵng</a></li>
                        <li><a href=""><i class="fa fa-phone"></i> 0815858468</a></li>
                    </ul>
                </div>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                           ...
                                           <span class="cart-item-amount">{{$product['qty']}}*<span>
                                                   ...
                                                   @else {{number_format($product['item']['unit_price']-$product['item']['promotion_price'])}}
                                                   @endif
                                               </span></span>
                                        </div>
                                    </div>
                    ...
                    <ul class="l-inline ov">
                        ...
                        <li><a href="#">Sản phẩm</a>
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('lsp',$loai->id) }}">{{$loai->name}}</a></li>
                                @endforeach
                            </ul>
                        </li>
